...
- **Gallery previews:** saved results include a trusted 200 px WebP thumbnail generated by the PC so the gallery can load without decrypting the full image; this preview is visible to the relay
